...
export const L2_CONTRIBUTION_CONTRACT_DEPLOYED_BLOCK = BigInt(
  config.L2_CONTRIBUTION_CONTRACT_DEPLOYED_BLOCK,
) as bigint;
export const BLOCK_BUILDER_REWARD_CONTRACT_ADDRESS =
  config.BLOCK_BUILDER_REWARD_CONTRACT_ADDRESS as `0x${string}`;
export const BLOCK_BUILDER_REWARD_CONTRACT_DEPLOYED_BLOCK = BigInt(
  config.BLOCK_BUILDER_REWARD_CONTRACT_DEPLOYED_BLOCK,
) as bigint;
